...
class CLASSIFIER:
    # train_Y is interger 
    def __init__(self, _train_X, _train_Y, data_loader, _nclass, _cuda, discriminator, _lr=0.001, _beta1=0.5, _nepoch=20, _batch_size=100, generalized=True):
    ...
    def fit_zsl(self):
        ...
        for epoch in range(self.nepoch):
            for i in range(0, self.ntrain, self.batch_size):      
                ...
                _, _, inputv = self.discriminator(inputv.cuda())
            ...
            _, _, test_unseen = self.discriminator(self.test_unseen_feature.cuda())
    ...
    def fit(self):
        ...
        for epoch in range(self.nepoch):
            ...
            _, _, test_seen = self.discriminator(self.test_seen_feature.cuda())
            _, _, test_unseen = self.discriminator(self.test_unseen_feature.cuda())
